...
*              in little-endian order
*              This function is only needed for OSKR-512
*
...
*              a centered binomial distribution with parameter OSKR_ETA1
*              specialized for OSKR_ETA1=3
*
...
* Description: Given an array of uniformly random bytes, compute
*              polynomial with coefficients distributed according to
*              a centered binomial distribution with parameter OSKR_ETA2
*              specialized for OSKR_ETA2=2
*
* Arguments:   - poly *r:                  pointer to output polynomial
*              - const unsigned char *buf: pointer to input byte array
*              - int add:                  boolean to indicate to accumulate into r
